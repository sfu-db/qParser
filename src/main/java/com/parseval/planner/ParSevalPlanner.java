...
import com.parseval.schema.mysql.*;
import com.parseval.schema.sqlite.*;
...
public class ParSevalPlanner  implements RelOptTable.ViewExpander{
    ...
    public ParSevalPlanner(SchemaPlus schema) {
    ...
    public static FrameworkConfig generateConfig(SchemaPlus schema) {
        ...
        return Frameworks.newConfigBuilder().defaultSchema(schema)
                .parserConfig(SqlParser.Config.DEFAULT.withLex(Lex.MYSQL_ANSI).withQuoting(Quoting.DOUBLE_QUOTE))
    ...
    private SqlValidator createSqlValidator(CalciteCatalogReader catalogReader) {
        ...
        return new ParSevalValidator(opTab, catalogReader, getTypeFactory(),
